...
const createPaymentSession = async (req, res) => {
  try {
    ...
    // Support both local and VPS environments for frontend URL
    let frontendUrl;

    // Check if we have a specific FRONTEND_URL set
    if (process.env.FRONTEND_URL) {
      // If it contains comma, take the first one (for compatibility)
