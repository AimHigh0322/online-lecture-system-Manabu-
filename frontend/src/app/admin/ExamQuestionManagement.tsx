    ...
    <BossLayout>
      <div className="p-3 md:p-6">
        ...
        <div className="mb-4 md:mb-6">
          ...
          <p className="text-sm md:text-base text-slate-600">試験問題の作成、編集、管理ができます</p>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-3 md:gap-4 items-stretch lg:items-center justify-between">
            ...
            <div className="flex flex-col md:flex-row gap-3 md:gap-4 flex-1 w-full">
              ...
              <select
                ...
                className="px-3 md:px-4 py-2 text-sm md:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent cursor-pointer"
              >
            ...
            <button
              ...
              className="bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-lg flex items-center justify-center gap-2 transition-colors text-sm md:text-base whitespace-nowrap"
            >
        ...
        <div className="bg-white rounded-xl shadow-lg border border-slate-200 overflow-hidden">
          ...
          {filteredQuestions.length > 8 && totalPages > 1 && (
            <Pagination
              page={page}
